...
import 'package:ecommerce_api_project/views/product_by_category.dart';
...
class Routes {
  ...
  static const String productByCategoryPage = "/productByCategoryPage";
  ...
  static var list = [
    ...
    GetPage(name: productByCategoryPage, page: () =>  ProductByCategory()),
  ];
}
